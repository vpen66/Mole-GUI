...
1. **从 [GitHub Releases](https://github.com/vpen66/Mole-GUI/releases) 下载最新的 DMG 文件**
...
```bash
# 1. 克隆仓库
git clone https://github.com/vpen66/Mole-GUI.git
cd Mole-GUI
...
**A:** 是的！本项目是开源的，你可以：
- 查看源代码：[GitHub 仓库](https://github.com/vpen66/Mole-GUI)
- 自行编译验证
- 提交 Issue 或 PR
...
1. 检查是否按照上述步骤操作
2. 查看 [GitHub Issues](https://github.com/vpen66/Mole-GUI/issues) 是否有类似问题
